package main.java.javaClasses.mainTask;
...
public class Students {
    ...
    public void facultyOfLaw() {
        if (this.getFaculty().toUpperCase().equals("LAW")) {
            System.out.println(toString());
        }
    }

    public void facultyOfGeo() {
        if (this.getFaculty().toUpperCase().equals("GEO")) {
            System.out.println(toString());
        }
    }

    public void facultyOfFir() {
        if (this.getFaculty().toUpperCase().equals("FIR")) {
            System.out.println(toString());
        }
    }

    public void facultyOfFsc() {
        if (this.getFaculty().toUpperCase().equals("FSC")) {
            System.out.println(toString());
        }
    }
